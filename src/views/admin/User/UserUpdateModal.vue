                  ...
                  <div class="col-12 d-flex flex-wrap">
                    ...
                    <div class="col-md-12">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9 d-flex align-items-center">
                           <select class="form-control" v-model="detail.position">
                            <option v-for="(item, index) in userPositions" :key="index" :value="item.id">{{ item.position}}</option>
                          </select>
                        </div>
                      </div>
                    </div>
...
const updateImage = async () =>{
  await axios({
    method: "POST",
    url: user.UPDATE_AVATAR + detail.value.id,
    headers: { Authorization: store.state.token, Accept: "application/json" },
