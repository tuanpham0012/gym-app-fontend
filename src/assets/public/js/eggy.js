    ...
    return _asyncToGenerator(function* () {
      ...
      return (
        ...
        _this3.options.message &&
          ((message = document.createElement("p")).classList.add("message"),
  ...
  addTheme() {
    ...
    return _asyncToGenerator(function* () {
      ...
      !document.querySelector(".eggy-theme") &&
        ...
        ((styles = document.createElement("style")).classList.add("eggy-theme"),
        (styles.innerHTML =
    ...
    return _asyncToGenerator(function* () {
      ...
      return (
        ...
        _this9.options.styles &&
          ...
          ((progressBarStyles = document.createElement("style")).innerHTML =
  ...
  buildDefaultOptions(userOptions) {
    ...
    switch (
      ...
      case "info":
        ...
        break;
      case "warning":
        (options.title = "Warning"), (options.message = "Please be careful!");
        break;
      case "error":
